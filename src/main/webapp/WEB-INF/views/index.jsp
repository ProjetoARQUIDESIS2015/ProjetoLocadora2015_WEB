  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <p>Oferecemos a você a praticidade e qualidade de um Sistema simples e funcional</p>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <p>Usando a linguagem de programação JAVA com conexão com banco de dado MySql, conseguimos realizar um sistema  de Locadora de veículos que foca na simplicidade e rapidez . </p>
          <p><a class="btn btn-default" href="#" role="button">Saiba mais &raquo;</a></p>
        </div>
        <div class="col-md-4">
          <h2>Vantagens</h2>
          <p>Sistema de fácil acesso, permite qualquer atendente iniciante aprender a usar em pouco tempo, não precisando de curso e assim reduzindo custos.</p>
          <p><a class="btn btn-default" href="#" role="button">Saiba mais &raquo;</a></p>
       </div>
        <div class="col-md-4">
          <h2>Benefícios</h2>
          <p>Segurança(contra crimes de sabotagem, espionagem e invasões de hacker).</p>
          <p><a class="btn btn-default" href="#" role="button">Saiba mais &raquo;</a></p>
        </div>
      </div>
